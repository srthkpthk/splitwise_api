import 'package:splitwise_api/src/util/data/model/expensesSection/postExpense/repayments.dart';
import 'package:splitwise_api/src/util/data/model/expensesSection/postExpense/created_by.dart';
import 'package:splitwise_api/src/util/data/model/expensesSection/postExpense/category.dart';
import 'package:splitwise_api/src/util/data/model/expensesSection/postExpense/receipt.dart';
...
class Expenses {
  ...
  final int email_reminder_in_advance;
  final Object next_repeat;
  final Object details;
  final int comments_count;
  final bool payment;
  final Object creation_method;
