import 'package:splitwise_api/src/util/data/model/friendsSection/friends/picture.dart';
import 'package:splitwise_api/src/util/data/model/friendsSection/friends/balance.dart';
import 'package:splitwise_api/src/util/data/model/friendsSection/friends/groups.dart';

class Friends {

  final int id;
  final String first_name;
  final Object last_name;
  final String email;
  ...
  final String updated_at;
	...
	Friends.fromJsonMap(Map<String, dynamic> map): 
		id = map["id"],
