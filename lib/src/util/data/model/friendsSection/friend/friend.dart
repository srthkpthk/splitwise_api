import 'package:splitwise_api/src/util/data/model/friendsSection/friend/picture.dart';
import 'package:splitwise_api/src/util/data/model/friendsSection/friend/balance.dart';
import 'package:splitwise_api/src/util/data/model/friendsSection/friend/groups.dart';
...
class Friend {
  ...
  final String updated_at;
	...
	Friend.fromJsonMap(Map<String, dynamic> map): 
		id = map["id"],
