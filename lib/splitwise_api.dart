...
//<editor-fold desc="Authorization Section">
  ...
  validateClient({String verifier, String token, String tokenSecret}) async {
    if (verifier == null && tokenSecret == null && token == null) {
    ...
    } else if ((verifier != null && verifier.isNotEmpty) &&
        (token == null) &&
        (tokenSecret == null)) {
      ...
      _client = oauth.Client(oauth.SignatureMethods.hmacSha1,
          _clientCredentials, oauth.Credentials(token, tokenSecret));
      return _client;
    }
  }
...
//<editor-fold desc="User Section">
  ...
  updateUser(int id, {Map<String, String> options}) =>
      _makePostRequest('update_user/$id', options: options);
...
//<editor-fold desc="Group Section">
  ...
  addUserToGroup(Map<String, String> options) =>
      _makePostRequest('add_user_to_group');

  /// This method is used to remove a user from Group

  removeUserFromGroup(Map<String, String> options) =>
      _makePostRequest('remove_user_from_group', options: options);
...
//<editor-fold desc="Friends Section">
  ...
  createFriend(Map<String, String> options) =>
      _makePostRequest('create_friend', options: options);

  /// This method is used to create multiple friends
  createFriends(Map<String, String> options) =>
      _makePostRequest('create_friends', options: options);
...
//<editor-fold desc="Expenses Section">
  ...
  getExpenses({Map<String, String> options}) =>
      _makeGetRequest('get_expenses', options: options);

  /// This method is used to create an Expense
  createExpense(Map<String, String> options) =>
      _makePostRequest('create_expense', options: options);

  /// This method is used to update an expense
  updateExpense(int id, Map<String, String> options) =>
      _makePostRequest('update_expense/$id', options: options);
...
//<editor-fold desc="Comments Section">
  ...
  createComment(Map<String, String> options) =>
...
//<editor-fold desc="Notification Section">
  ...
  getNotifications({Map<String, String> options}) =>
      _makeGetRequest('get_notifications', options: options);
...
//<editor-fold desc="Currencies Section">
  ...
  parseSentence(Map<String, String> options) =>
